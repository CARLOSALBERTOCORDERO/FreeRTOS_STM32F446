 ...
 *          License:  CBD1800751
 *
 *      Description:  C-Code implementation template for SW-C <CpAp1>
 *********************************************************************************************************************/
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Read_Pp_Cnt_Cnt_u16(UInt16 *data)
 *
...
FUNC(void, CpAp1_CODE) CpAp1_1s(void) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
